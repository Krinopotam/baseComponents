...
export const ContainerRender = ({tableRef, gridApi, gridProps}: {tableRef: React.MutableRefObject<ITabulator | undefined>; gridApi: IGridApi; gridProps:IGridProps}): JSX.Element => {
